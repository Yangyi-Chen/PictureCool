...
extension UIColor {
    ...
    static var rose:UIColor {
        return UIColor(red: 238, green: 213, blue: 210)
    }
    static var sea:UIColor {
        return UIColor(red: 122, green: 197, blue: 205)
    }
    ...
    static var stillBlue:UIColor{
        return UIColor(red: 92, green: 172, blue: 248)
    }
    
    static var skyBlue:UIColor{
        return UIColor(red: 126, green: 192, blue: 238)
    }
